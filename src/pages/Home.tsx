          ...
          <div className="flex-1 flex flex-col gap-6 w-full min-w-0">
            ...
            <div className="flex flex-col gap-6 mt-8">
              <div className="flex flex-col gap-2">
                ...
                <div className="text-on-surface-variant text-base md:text-lg leading-relaxed font-body">
                  <p>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="text-on-surface-variant text-base md:text-lg leading-relaxed font-body">
                  <p>
                    I am a dedicated mechanical engineering student specializing in robotic systems and sustainable innovation. My work focuses on bridging the gap between advanced manufacturing and environmental stewardship through the deployment of intelligent mechanical solutions.
                  </p>
                </div>
              </div>
            </div>
